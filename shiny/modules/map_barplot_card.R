...
#' \code{mapBarplotCardUI} generates the user interface for each card
#' \code{mapBarplotCard} generates the map+barplot shown in the card

## map+barplot card ui function ----
mapBarplotCardUI <- function(id,
                             title_text = NULL,
                             sub_title_text = NULL,
                             source_text = NULL,
...
## map+barplot card server function ----
mapBarplotCard <- function(input,
                           output,
                           session,
                           goal_code,
                           dimension_selected,
