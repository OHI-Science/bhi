...
comparing_scores <- function(score_df1, score_df2, name_df1 = "2015", name_df2 = "2019", calcforYr = 2014){
  ...
  compare_scores <- score_df1 %>% # with version 2019 data
    rename(scores1 = score) %>%
    left_join(
      rename(score_df2, scores2 = score),
...
result_oldfun <- comparing_scores(result_v2019dat_oldfun$scores, result_v2015dat_oldfun$scores)
...
result_newfun <- comparing_scores(result_v2019dat_newfun$scores, result_v2015dat_newfun$scores)
